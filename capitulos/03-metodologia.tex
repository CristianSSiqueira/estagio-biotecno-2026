...
A redação deste relatório contou com o auxílio do modelo de inteligência artificial
\textbf{Claude Sonnet 4.6}, desenvolvido pela Anthropic, utilizado como ferramenta de apoio
à estruturação, revisão e correção textual do documento, ou seja, ao processo de escrita acadêmico, contribuindo para a clareza e coesão do texto. O conteúdo técnico, as decisões de
implementação e as análises apresentadas são de autoria própria.